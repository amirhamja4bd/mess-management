...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 px-4 pt-4 pb-0", className)}
      {...props}
    />
  )
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col-reverse gap-2 border-t bg-muted/50 px-4 py-3 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
